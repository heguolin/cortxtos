...
**版本** v2.1 · 2026-09-18 · 定稿（v2.0 = 三轮 grilling 共识固化；v2.1 = grill-with-docs 轮修订：检索形态两段式、引用点击边界、模型角色正名、密码生命周期。配套：术语纪律见 CONTEXT.md，决策记录见 docs/adr/0001–0004。v1 的 H:\day\DESIGN.md 与 PDF 方案已作废，仅存参考）
